...
<input type="hidden" name="id" value="{{$product->id}}">
    <div class="product">
        <div class="product_img img-file">
            ...
            <img src="{{route('image',$product->image)}}" class="thumbails" alt="">
        ...
        <div class="product_detail">
            ...
            <label class="">
                <span>Tên: </span>
                <input type="text" name="name" value="{{$product->name}}"  placeholder="Điền tên sản phẩm ...">
            </label>
            <p class="hidden alert-error" name='unit_price'></p>
            <label>
                <span>Giá: </span>
                <div class="quantity">
                    <input type="number" name="unit_price" min='0' step="1000" value="{{$product->unit_price}}" >
                </div>
            </label>
            ...
            <label>
                ...
                <div class="quantity">
                    <input type="number" name="promotion_price" step='1000' min="0" value="{{$product->promotion_price}}" >
                </div>
            </label>
    ...
    <div class="product-description">
        ...
        <textarea name="description"  style="width:100%;" rows="10" placeholder="Mô tả sản phẩm...">{{$product->description}}</textarea>
    </div>
            ...
            $.each(mess.responseJSON.errors, function (i, val) {
                $.each($('.alert-error'), function (index, value) { 
                    ...
                    if(i === value.getAttribute('name')){
                        ...
                        // alert.appendBefore(value);
                        // //  value.after(`<p class='alert alert-error'>${val}</p>`)
                     }
                });
